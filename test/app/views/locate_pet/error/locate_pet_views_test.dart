...
void main() {
  testWidgets('LocatePetErrorView handles state correctly', (WidgetTester tester) async {
    // Usar o mock
    final mockState = LocatePetMockErrorState(message: "Erro simulado");

    // Certifique-se de envolver o seu widget em um MaterialApp ou similar, se necessário
    await tester.pumpWidget(MaterialApp(home: LocatePetErrorView(state: mockState)));
